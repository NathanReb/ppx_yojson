let test_is_binary =
  ...
  in
  [ make_test "0b1" true; make_test "0B1" true; make_test "123" false ]
...
let test_is_octal =
  let make_test input expected =
    ...
    (test_name, `Quick, test_fun)
  in
  [ make_test "0o1" true; make_test "0O1" true; make_test "123" false ]
...
let test_is_hexadecimal =
  let make_test input expected =
    ...
    (test_name, `Quick, test_fun)
  in
  [ make_test "0x1" true; make_test "0X1" true; make_test "123" false ]

let suite =
  ( "Integer_const",
    List.concat [ test_is_binary; test_is_octal; test_is_hexadecimal ] )
